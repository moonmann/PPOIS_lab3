...
class PlayState(State):
    ...
    def enter_new_screen(self):
        ...
        green_chickens_group = pygame.sprite.Group()
        green_chickens_group.add(ChickenGreen(screen, randint(100, 500)))
        ...
        check, score = play_loop(
            ...
            cursor,
            cursor_group,
            chickens_small_group,
            chickens_mid_group,
            chickens_big_group,
            green_chickens_group,
            ammo,
            ammo_group,
            score_manager,
            scores_group,
